...
const getBusinessInfo = async (sirenOrSiret) => {
    ...
    const params = {
        ...
        nombre: 1,
        champs: 'siren,categorieJuridiqueUniteLegale,activitePrincipaleUniteLegale,denominationUniteLegale,dateCreationUniteLegale'
    };
    ...
    try {
        ...
        const periodeActive = uniteLegale.periodesUniteLegale.find(periode => !periode.dateFin);
